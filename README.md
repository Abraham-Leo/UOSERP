# 🏭 UOS ERP — Complete Installation Guide
...
# 6. Create database
mysql -u root -p -e "CREATE DATABASE uos_erp CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
- [ ] Set up scheduler: add to crontab:
      `* * * * * php /var/www/uos-erp/artisan schedule:run`
...
*UOS ERP System — Built for Manufacturing & Distribution Companies*
